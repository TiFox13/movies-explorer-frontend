  ...
  return (
    <section className='project'>
      ...
      <div className='schema'>
        <p className='schema__time back-time'>1 неделя</p>
        <p className='schema__time front-time'>4 недели</p>
        <p className='schema__info back-info'>Back-end</p>
        <p className='schema__info front-info'>Front-end</p>
      </div>
    </section>
  )
}
