  ...
  return (
    <form className='form' name={props.name} method='post' >
      ...
      <label className = {`form__input-field name-input-field ${props.hiddenClass}`}>Имя
          <input value={name} onChange={handleChangeName} type='text' id ='name-input' placeholder='Введите ваше имя (2 - 30 символов)' className='form__item form__item_name' name='name' required minLength='2' maxLength='40' />
          <span className = 'form__item-error name-input-error'>{nameError}</span>
        </label>
      <label className = 'form__input-field'>E-mail
          <input value={email} onChange={handleChangeEmail} type='text' id ='email-input' placeholder='Введите ваш email' className='form__item form__item_email' name='email'  required minLength='2' maxLength='200' />
      ...
      <label className = 'form__input-field password-input-field'>Пароль
          <input value={password} onChange={handleChangePassword} type='text' id ='password-input' placeholder='Длина пароля не меньше 4 символов' className='form__item form__item_password' name='password'  required minLength='4' maxLength='200' />
